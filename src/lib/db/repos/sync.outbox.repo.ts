...
export function makeTaskCompleteOutboxId(petId: string, day: string, taskKey: string) {
...
export async function markOutboxFailed(id: string, errorMsg: string): Promise<void> {
  await execute(
    `UPDATE sync_outbox
