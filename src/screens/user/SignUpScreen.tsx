      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: palette.text }]}>{t('signup.title')}</Text>
            <Text style={[styles.subtitle, { color: palette.subText }]}>{t('signup.subtitle')}</Text>
          </View>

          <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
            <Text style={[styles.label, { color: palette.text }]}>{t('signup.fields.displayNameOptional')}</Text>
            ...
            <Text style={[styles.label, { marginTop: theme.spacing.md, color: palette.text }]}>
            ...
            <View style={[styles.inputRow, { backgroundColor: palette.inputBg, borderColor: palette.border }]}>
              ...
              <TextInput
                ...
                editable={!loading}
              />
              <Pressable onPress={() => setShowPw(!showPw)} style={styles.eyeBtn} disabled={loading}>
            ...
            <Pressable onPress={() => navigation.replace('Login')} style={styles.linkBtn} disabled={loading}>
              <Text style={[styles.linkText, { color: palette.subText }]}>{t('signup.links.toLogin')}</Text>
            </Pressable>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
