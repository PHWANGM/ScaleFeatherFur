...
export default function PetsHeader({ onAddPress }: Props) {
  ...
  const avatarUri = pet?.avatar_uri ??
    "https://picsum.photos/seed/sff-avatar/200/200"
      ...
      {loading
        ...
        : (
          <View style={styles.row}>
            ...
            <View style={{ flex: 1 }}>
              <Text
                style={[styles.petName, { color: palette.text }]}
                numberOfLines={1}
              >
                {titleName}
              </Text>
              <Text
                style={[styles.petMeta, { color: palette.subText }]}
                numberOfLines={1}
              >
                {speciesLabel}
              </Text>
