...
export default function PetPickerModal(
  { visible, onClose, onSelect, filter }: Props,
) {
          ...
          {loading
            ? (
              <View style={styles.centerBox}>
                ...
                <Text style={[styles.loading, { color: palette.subText }]}>
                  Loading...
                </Text>
              </View>
            )
                  ...
                  return (
                    ...
                    >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <Text
                          style={[styles.meta, { color: palette.subText }]}
                          numberOfLines={1}
                        >
                          {speciesLabel}
